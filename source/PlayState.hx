...
import flixel.graphics.frames.FlxFrame;package; // "Most hard-coded FNF mod ever!!!!!!!!!!" - p0kk0 on GameBanana(https://gamebanana.com/mods/43201?post=10328553)
...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if (FlxG.save.data.songPosition && !isGreetingsCutscene && !['five-nights', 'overdrive'].contains(SONG.song.toLowerCase()))
		{
			...
			botplayTxt.setFormat(Paths.font("Comic Sans MS Bold"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
